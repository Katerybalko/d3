...
from newses.models import Post, Subscription
...
def send_weekly_newsletter():
    ...
    posts = Post.objects.filter(published__gte=last_week)
    ...
    plain_message = strip_tags(html_message)
    send_mail(subject, plain_message, 'katerybalko2022@yandex.ru', list(subscribers), html_message=html_message)